...
- **Overall progress:** 0 / 15 phases · 0 / 82 tasks done (0%)
- **Active phase:** P0 — Foundation, Tooling & CI Skeleton
- **Blocked:** none
...
| --- | -------------------------------------------- | ----------------------------------- | ------ | -------- | ---- | ------------ |
| P0  | Foundation, Tooling & CI Skeleton            | `phase-00-foundation-ci.md`         | 🔄     | 3 / 7    | L    | 2026-06-23   |
